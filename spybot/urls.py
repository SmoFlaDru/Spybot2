...
urlpatterns = [
    ...
    path(
        ...
        views.recent_events_fragment,
        name="recent_events_fragment",
    ),
    ...
    path(
        "profile/steamid/all",
        views.profile_steamids_fragment,
        name="profile_steamids_fragment",
    ),
    path(
        "profile/steamid/<str:id>",
        views.profile_delete_steamid,
        name="profile_delete_steamid",
    ),
    ...
    path(
        ...
        passkeys.generate_authentication_options,
        name="passkeys_generate-authentication-options",
    ),
    path(
        "passkeys/generate-registration-options",
        passkeys.generate_registration_options,
        name="passkeys_generate-registration-options",
    ),
    path(
        "passkeys/verify-registration",
        passkeys.verify_registration,
        name="passkeys_verify-registration",
    ),
    path(
        "passkeys/verify-authentication",
        passkeys.verify_authentication,
        name="passkeys_verify-authentication",
    ),
    # API
